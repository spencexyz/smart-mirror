...
var renderWidget = function(lat, lon, color, $attachPoint) {
  ...
  var ForecastEmbed = function(e) {
      ...
      return t.loading = function(e) {
          ...
          n.find(".fe_title .fe_forecast_link a").attr("href", "http://forecast.io/#/f/" + e.latitude + "," + e.longitude), f(e), l(e), c(e), $("body").hasClass("hide_daily") || i.play()
      }, s(), t
  };
  ...
  embed.elem.prependTo($attachPoint);
  embed.loading(true)
  forecast_request = $.get("/weather", function(f) {
    embed.build(f)
    embed.loading(false)
  })
}
